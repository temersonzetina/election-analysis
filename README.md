## Election_Analysis
### Project Overview
The purpose of this analysis was to uplift key findings from a recent congressional election for the Colorado Board of Elections. The tasks listed immediately below comprise the key tasks for the analysis.
...
6. Calculate the percentage of votes from each county based on the total votes.
...
* Denver County had the highest turnout, with 306,055 votes cast. This constituted 82.8% of the election's total votes,
* The candidates were:
...
Analysts would need to add additional script featuring new lists and dictionaries to work with these fields. In looping through the data, analysts would need to account for these additional elements. However, the same basic concepts applied in this analysis would apply.
